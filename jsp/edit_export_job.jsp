    ...
    <html:form action="/ext/content_importer/edit_export_job" styleId="fm">
        ...
        <div id="mainTabContainer" dojoType="dijit.layout.TabContainer" dolayout="false">
            ...
            <div id="fileBasicTab" dojoType="dijit.layout.ContentPane"
                 title="<%= LanguageUtil.get(pageContext, "exporter.create.tabtitle") %>">
                <dl>
                    <dt><img
                            src="/html/images/icons/required.gif"/> <%=LanguageUtil.get(pageContext, "content-exporter-task-name")%>:
                        <br/><em><%=LanguageUtil.get(pageContext, "content-exporter-task-name-hint")%>
                        </em>
                    </dt>
                    <dd><input class="form-text" dojoType="dijit.form.TextBox" name="jobName" id="jobName"
                               value="<%= UtilMethods.isSet(contentExporterForm.getJobName()) ? contentExporterForm.getJobName() : "" %>"
                               style="width: 300px;" type="text"></dd>
                    <dt><%=LanguageUtil.get(pageContext, "content-exporter-task-description")%>:
                        <br/><em><%=LanguageUtil.get(pageContext, "content-exporter-task-description-hint")%>
                        </em>
                    </dt>
                    <dd><input class="form-text" dojoType="dijit.form.TextBox" name="jobDescription" id="jobDescription"
                               value="<%= UtilMethods.isSet(contentExporterForm.getJobDescription()) ? contentExporterForm.getJobDescription() : "" %>"
                               style="width: 300px;" type="text"></dd>
                    ...
                    <dd>
                        ...
                        <br/><br/><input type="radio"
                                         dojoType="dijit.form.RadioButton" <%=!contentExporterForm.isHaveCronExpression() ? "checked" : ""%>
                                         id="haveCronExpression2" name="haveCronExpression" value="false"
                                         onclick="showRegularDates(this)"/> <%=LanguageUtil.get(pageContext, "content-exporter-dont-use-cronexpression")%>
                        <br/><em><%=LanguageUtil.get(pageContext, "content-exporter-dont-use-cronexpression-hint")%>
                    </em>
                    </dd>
                    <div id="regularDates">
                        <dd>
                            <div style="margin-left:20px;">
                                <input type="radio" name="at" id="at1" dojoType="dijit.form.RadioButton"
                                       value="isTime" <%= UtilMethods.isSet(contentExporterForm.getAt()) && contentExporterForm.getAt().equals("isTime") ? "checked" : "" %> >
                                <span><img
                                    ...
                                    <%
                                        for (int idx = 0; idx < 24; idx++) {
                                            ...
                                            if (val == 0)
                                                val = 12;
                                    %>
                                    <option <%= contentExporterForm.getAtTimeHour() == idx ? "selected" : "" %>
                                            value="<%= idx %>"><%= val %>
                                    </option>
                                    <%
                                        }
                                ...
                                <select dojoType="dijit.form.FilteringSelect" style="width: 80px;" name="atTimeMinute">
                                    <%
                                        for (int idx = 0; idx < 60; ++idx) {
                                            String val = (idx < 10) ? "0" + idx : String.valueOf(idx);
                                    %>
                                    <option <%= contentExporterForm.getAtTimeMinute() == idx ? "selected" : "" %>
                                            value="<%= idx %>"><%= val %>
                                    </option>
                                    <%
                                        }
                                ...
                                <select dojoType="dijit.form.FilteringSelect" style="width: 80px;" name="atTimeSecond">
                                    <%
                                        for (int idx = 0; idx < 60; ++idx) {
                                            String val = (idx < 10) ? "0" + idx : String.valueOf(idx);
                                    %>
                                    <option <%= contentExporterForm.getAtTimeSecond() == idx ? "selected" : "" %>
                                            value="<%= idx %>"><%= val %>
                                    </option>
                                    <%
                                        }
                        ...
                        <dd>
                            <div style="margin-left:20px;">
                                <input type="radio" name="at" id="at" dojoType="dijit.form.RadioButton"
                                       value="isBetween" <%= UtilMethods.isSet(contentExporterForm.getAt()) && contentExporterForm.getAt().equals("isBetween") ? "checked" : "" %>/>
                                <span><img
                                    ...
                                    <%
                                        for (int idx = 0; idx < 24; idx++) {
                                            ...
                                            if (val == 0)
                                                val = 12;
                                    %>
                                    <option <%= contentExporterForm.getBetweenFromHour() == idx ? "selected" : "" %>
                                            value="<%= idx %>"><%= val %>
                                    </option>
                                    <%
                                        }
                                    ...
                                    <%
                                        for (int idx = 0; idx < 24; idx++) {
                                            ...
                                            if (val == 0)
                                                val = 12;
                                    %>
                                    <option <%= contentExporterForm.getBetweenToHour() == idx ? "selected" : "" %>
                                            value="<%= idx %>"><%= val %>
                                    </option>
                                    <%
                                        }
                                ...
                                <div style="display: none;">
                                    <input type="checkbox" dojoType="dijit.form.CheckBox" id="eachInfo"
                                           name="eachInfo" <%=contentExporterForm.isEachInfo() ? "checked" : ""%>/>
                                </div>
                                <span><%= LanguageUtil.get(pageContext, "each") %> <input type="text"
                                                                                          ...
                                                                                          name="eachHours"
                                                                                          id="eachHours"
                                                                                          maxlength="3"  <%= 0 < contentExporterForm.getEachHours() ? "value=\"" + contentExporterForm.getEachHours() + "\"" : "" %> > <%= LanguageUtil.get(pageContext, "hours-and") %> <input
                                        type="text" class="form-text" dojoType="dijit.form.TextBox" style="width: 30px;"
                                        name="eachMinutes" id="eachMinutes"
                                        maxlength="3" <%= 0 < contentExporterForm.getEachMinutes() ? "value=\"" + contentExporterForm.getEachMinutes() + "\"" : "" %> > <%= LanguageUtil.get(pageContext, "minutes") %></span>
                                <%
                        ...
                        <dd>
                            <div style="margin-left:20px;">
                                <input type="checkbox" dojoType="dijit.form.CheckBox" id="everyInfo"
                                       name="everyInfo" <%=contentExporterForm.isEveryInfo() ? "checked" : "" %>/>
                                <span><%=LanguageUtil.get(pageContext, "every").toLowerCase()%></span>
                                <br/><em><%=LanguageUtil.get(pageContext, "content-exporter-every-hint")%>
                            </em>
                            </div>
                        </dd>
                        <dd>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="every" id="every" dojoType="dijit.form.RadioButton"
                                               value="isDate" <%= UtilMethods.isSet(contentExporterForm.getEvery()) && contentExporterForm.getEvery().equals("isDate") ? "checked" : "" %> >
                                        <select dojoType="dijit.form.FilteringSelect" style="width: 120px;"
                                            ...
                                            <%
                                                for (int idx = 0; idx < months.length; idx++) {
                                            %>
                                            <option <%= (contentExporterForm.getEveryDateMonth() - 1) == monthIds[idx] ? "selected" : "" %>
                                                    value="<%= monthIds[idx] %>"><%= months[idx] %>
                                            </option>
                                            <%
                                                }
                                        ...
                                        <select dojoType="dijit.form.FilteringSelect" style="width: 80px;"
                                            ...
                                            <%
                                                for (int idx = 1; idx <= 31; idx++) {
                                            %>
                                            <option <%= contentExporterForm.getEveryDateDay() == idx ? "selected" : "" %>
                                                    value="<%= idx %>"><%= idx %>
                                            </option>
                                            <%
                                                }
                                        ...
                                        <select dojoType="dijit.form.FilteringSelect" style="width: 80px;"
                                            ...
                                            <%
                                                for (int idx = currentYear - previous; idx <= currentYear + 10; idx++) {
                                            %>
                                            <option <%= contentExporterForm.getEveryDateYear() == idx ? "selected" : "" %>
                                                    value="<%= idx %>"><%= idx %>
                                            </option>
                                            <%
                                                }
                        ...
                        <dd>
                            <table style="margin-left:40px;" width="200">
                                <tr>
                                    <td rowspan="2">
                                        <input type="radio" name="every" id="every1" dojoType="dijit.form.RadioButton"
                                               value="isDays" <%= UtilMethods.isSet(contentExporterForm.getEvery()) && contentExporterForm.getEvery().equals("isDays") ? "checked" : "" %> >
                                    </td>
                                    <td align="center">
                                ...
                                <tr>
                                    <td align="center">
                                        <input type="checkbox" dojoType="dijit.form.CheckBox" name="everyDay"
                                               id="everyDay1"
                                               value="MON" <%= contentExporterForm.isMonday() ? "checked" : "" %> >
                                    </td>
                                    <td align="center">
                                        <input type="checkbox" dojoType="dijit.form.CheckBox" name="everyDay"
                                               id="everyDay2"
                                               value="TUE" <%= contentExporterForm.isTuesday() ? "checked" : "" %> >
                                    </td>
                                    <td align="center">
                                        <input type="checkbox" dojoType="dijit.form.CheckBox" name="everyDay"
                                               id="everyDay3"
                                               value="WED" <%= contentExporterForm.isWednesday() ? "checked" : "" %> >
                                    </td>
                                    <td align="center">
                                        <input type="checkbox" dojoType="dijit.form.CheckBox" name="everyDay"
                                               id="everyDay4"
                                               value="THU" <%= contentExporterForm.isThusday() ? "checked" : "" %> >
                                    </td>
                                    <td align="center">
                                        <input type="checkbox" dojoType="dijit.form.CheckBox" name="everyDay"
                                               id="everyDay5"
                                               value="FRI" <%= contentExporterForm.isFriday() ? "checked" : "" %> >
                                    </td>
                                    <td align="center">
                                        <input type="checkbox" dojoType="dijit.form.CheckBox" name="everyDay"
                                               id="everyDay6"
                                               value="SAT" <%= contentExporterForm.isSaturday() ? "checked" : "" %> >
                                    </td>
                                    <td align="center">
                                        <input type="checkbox" dojoType="dijit.form.CheckBox" name="everyDay"
                                               id="everyDay7"
                                               value="SUN" <%= contentExporterForm.isSunday() ? "checked" : "" %> >
                                    </td>
                                </tr>
                            </table>
                        </dd>
                    ...
                    <dd>
                        ...
                        <div id="cronDiv" style="margin-left:20px;">
                            <br/><img
                                ...
                                id="cronExpression"
                                value="<%= UtilMethods.isSet(contentExporterForm.getCronExpression()) ? contentExporterForm.getCronExpression().replaceAll("\"","&quot;"):"" %>"
                    ...
                    <dt><img
                            src="/html/images/icons/required.gif"/> <%=LanguageUtil.get(pageContext, "Structure-to-Export")%>:
                        <br/><em><%=LanguageUtil.get(pageContext, "Structure-to-Export-hint")%>
                        </em>
                    </dt>
                    <dd>
                        <select dojoType="dijit.form.FilteringSelect" name="structure" id="structuresSelect"
                                onchange="structureChanged()"
                                value="<%= UtilMethods.isSet(contentExporterForm.getStructure()) ? contentExporterForm.getStructure() : "" %>">
                            <%
                    ...
                    <dt><img
                            src="/html/images/icons/required.gif"/> <%=LanguageUtil.get(pageContext, "Language-of-the-Contents-to-Export")%>:
                        <em><%=LanguageUtil.get(pageContext, "Language-of-the-Contents-to-Export-hint")%>
                        </em>
                    </dt>
                    <dd>
                        <br/><select dojoType="dijit.form.FilteringSelect" name="language" id="languageSelect"
                                     value="<%= UtilMethods.isSet(contentExporterForm.getLanguage()) ? contentExporterForm.getLanguage() : "-1" %>">
                        <%
                    ...
                    <div id="structureFieldsDiv" style="display:none;">
                        <dt><%=LanguageUtil.get(pageContext, "Fields-to-export")%>:
                            <em><%=LanguageUtil.get(pageContext, "Fields-to-export-hint")%>
                            </em>
                        </dt>
                        <dd>
                            <table>
                    ...
                    <dt><img
                            src="/html/images/icons/required.gif"/> <%=LanguageUtil.get(pageContext, "content-exporter-file-target")%>:
                    </dt>
                    <dd>
                        <input type="radio"
                               dojoType="dijit.form.RadioButton" <%=(!contentExporterForm.isHaveFileTarget()) ? "checked" : "" %>
                               id="haveFilePath" name="haveFileTarget" value="false"
                               onclick="toggleFileTarget(this)"/> <%=LanguageUtil.get(pageContext, "content-exporter-use-filepath")%>
                        <div id="filePathDiv" style="margin-left:20px;">
                            <img src="/html/images/icons/required.gif"/> <%=LanguageUtil.get(pageContext, "content-exporter-file-path-title")%>: <input class="form-text" dojoType="dijit.form.TextBox" name="filePath" size="75"
                                     id="filePath"
                                     value="<%= UtilMethods.isSet(contentExporterForm.getFilePath()) ? contentExporterForm.getFilePath() : "" %>"
                                     style="width: 300px;" type="text">
                            <br/>
                            <em><%=LanguageUtil.get(pageContext, "content-exporter-file-path-hint")%>
                            </em>
                            <br/>
                            <br/>
                            <input type="checkbox" class="form-text" dojoType="dijit.form.CheckBox" name="overWriteFile"
                                   id="overWriteFile"
                                   value="true" <%= contentExporterForm.isOverWriteFile() ? "checked" : "" %> > <%=LanguageUtil.get(pageContext, "content-exporter-overwrite-file")%>
                            <br/>
                            <em><%=LanguageUtil.get(pageContext, "content-exporter-overwrite-file-hint")%>
                            </em>
                        </div>
                        <br/>
                        <input type="radio"
                               dojoType="dijit.form.RadioButton" <%=(contentExporterForm.isHaveFileTarget()) ? "checked" : "" %>
                               id="haveFileAsset" name="haveFileTarget" value="true"
                               onclick="toggleFileTarget(this)"/> <%=LanguageUtil.get(pageContext, "content-exporter-use-fileasset")%>
                        <div id="fileAssetDiv" style="margin-left:20px;">
                            <img src="/html/images/icons/required.gif"/> <%=LanguageUtil.get(pageContext, "content-exporter-file-asset-title")%>: <select dojoType="dijit.form.FilteringSelect" name="fileAsset" id="fileAsset"
                                      value="<%= UtilMethods.isSet(contentExporterForm.getFileAsset()) ? contentExporterForm.getFileAsset() : "" %>">
                            <%
                            ...
                            %>
                            <option <%= structure.getVelocityVarName().equals(contentExporterForm.getFileAsset()) ? "selected" : "" %>
                            ...
                            <br/>
                            <em><%=LanguageUtil.get(pageContext, "content-exporter-file-asset-hint")%>
                            </em>
                            <br/>
                            <br/>
                            <img src="/html/images/icons/required.gif"/> <%=LanguageUtil.get(pageContext, "content-exporter-file-asset-host-title")%>: <select dojoType="dijit.form.FilteringSelect" name="fileAssetHost" id="fileAssetHost"
                                      value="<%= UtilMethods.isSet(contentExporterForm.getFileAssetHost()) ? contentExporterForm.getFileAssetHost() : APILocator.getHostAPI().findDefaultHost(APILocator.getUserAPI().getSystemUser(), false).getHostname() %>">
                            <%
                            ...
                            %>
                            <option <%= (host.getHostname().equals(contentExporterForm.getFileAssetHost()) || (!UtilMethods.isSet(contentExporterForm.getFileAssetHost()) && host.getHostname().equals(APILocator.getHostAPI().findDefaultHost(APILocator.getUserAPI().getSystemUser(), false).getHostname()))) ? "selected" : "" %>
                                    value="<%= host.getHostname() %>"><%= host.getHostname() %>
                            </option>
                            <%
                                    }
                                }
                            ...
                            <br/>
                            <em><%=LanguageUtil.get(pageContext, "content-exporter-file-asset-host-hint")%>
                            </em>
                            <br/>
                            <br/>
                            <img src="/html/images/icons/required.gif"/> <%=LanguageUtil.get(pageContext, "content-exporter-file-asset-path-title")%>: <input class="form-text" dojoType="dijit.form.TextBox" name="fileAssetPath" size="200"
                                     id="fileAssetPath"
                                     value="<%= UtilMethods.isSet(contentExporterForm.getFileAssetPath()) ? contentExporterForm.getFileAssetPath() : "" %>"
                                     style="width: 500px;" type="text">
                            <br/>
                            <em><%=LanguageUtil.get(pageContext, "content-exporter-file-asset-path-hint")%>
                            </em>
                        </div>
                    </dd>
                    <script>
                    ...
                    <dt><img
                            src="/html/images/icons/required.gif"/> <%=LanguageUtil.get(pageContext, "content-exporter-csv-separator-delimiter")%>:
                        <br/><em><%=LanguageUtil.get(pageContext, "content-exporter-csv-separator-delimiter-hint")%>
                        </em>
                    </dt>
                    <dd><input class="form-text" dojoType="dijit.form.TextBox" name="csvSeparatorDelimiter"
                                    size="75" id="csvSeparatorDelimiter"
                                    value="<%= UtilMethods.isSet(contentExporterForm.getCsvSeparatorDelimiter()) ? contentExporterForm.getCsvSeparatorDelimiter() : "," %>"
                                    style="width: 300px;" type="text" size="3"></dd>
                    <dt><img
                            src="/html/images/icons/required.gif"/> <%=LanguageUtil.get(pageContext, "content-exporter-csv-text-delimiter")%>:
                        <br/><em><%=LanguageUtil.get(pageContext, "content-exporter-csv-text-delimiter-hint")%>
                        </em>
                    </dt>
                    <dd><input class="form-text" dojoType="dijit.form.TextBox" name="csvTextDelimiter" size="75"
                               id="csvTextDelimiter"
                               value="<%= UtilMethods.isSet(contentExporterForm.getCsvTextDelimiter()) ? contentExporterForm.getCsvTextDelimiter().replaceAll("\"","&quot;"):"&quot;" %>"
                               style="width: 300px;" type="text" size="3"></dd>
                    <dt><%=LanguageUtil.get(pageContext, "content-exporter-report-email")%>:
                        <br/><em><%=LanguageUtil.get(pageContext, "content-exporter-report-email-hint")%>
                        </em>
                    </dt>
                    <dd><input class="form-text" dojoType="dijit.form.TextBox" name="reportEmail" size="75"
                               id="reportEmail"
                               value="<%= UtilMethods.isSet(contentExporterForm.getReportEmail()) ? contentExporterForm.getReportEmail() : "" %>"
                               style="width: 300px;" type="text"></dd>
                </dl>
